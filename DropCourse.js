document.addEventListener("DOMContentLoaded", function () {
    document.getElementById("dropForm").addEventListener("submit", function (event) {
        ...
        let firstName = document.getElementById("dropFirstName").value.trim();
        let lastName = document.getElementById("dropLastName").value.trim();
        let year = document.getElementById("dropYear").value.trim();
        let coursePrefix = document.getElementById("dropCoursePrefix").value.trim();
        let courseNumber = document.getElementById("dropCourseNumber").value.trim();
        let courseSection = document.getElementById("dropCourseSection").value.trim();
        ...
        alert(`Student Name: ${firstName} ${lastName}\nYear: ${year}\nCourse Dropped: ${coursePrefix} ${courseNumber} - Section ${courseSection}`);
    });
});
